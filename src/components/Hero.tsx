...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <a
        href="/login"
        className="absolute top-8 right-8 z-20 px-5 py-2 bg-white text-primary font-semibold rounded-lg shadow hover:bg-primary hover:text-white transition text-lg"
      >
        Login
      </a>
